[![Build Status](https://travis-ci.org/christian-draeger/codefreeze-kotlin-session.svg?branch=master)](https://travis-ci.org/christian-draeger/codefreeze-kotlin-session)
